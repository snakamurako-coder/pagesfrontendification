function setupSystem() {
  ...
  if (!trainingSheet) {
    ...
    const patterns = [
      ["全員", "単元A", "英単語→日本語", "4択", "順番通り"],
      ["全員", "単元A", "英単語→日本語", "4択", "ランダム"],
      ["全員", "単元A", "英単語→日本語", "タイピング", "順番通り"],
      ["全員", "単元A", "英単語→日本語", "タイピング", "ランダム"],
      ["全員", "単元A", "英単語→日本語", "音声", "順番通り"],
      ["全員", "単元A", "英単語→日本語", "音声", "ランダム"],
      ["全員", "単元A", "日本語→英単語", "4択", "順番通り"],
      ["全員", "単元A", "日本語→英単語", "4択", "ランダム"],
      ["全員", "単元A", "日本語→英単語", "タイピング", "順番通り"],
      ["全員", "単元A", "日本語→英単語", "タイピング", "ランダム"],
      ["全員", "単元A", "日本語→英単語", "音声", "順番通り"],
      ["全員", "単元A", "日本語→英単語", "音声", "ランダム"],
      ["全員", "単元A", "音声→日本語", "4択", "順番通り"],
      ["全員", "単元A", "音声→日本語", "4択", "ランダム"],
      ["全員", "単元A", "音声→日本語", "タイピング", "順番通り"],
      ["全員", "単元A", "音声→日本語", "タイピング", "ランダム"],
      ["全員", "単元A", "音声→日本語", "音声", "順番通り"],
      ["全員", "単元A", "音声→日本語", "音声", "ランダム"],
      ["全員", "単元A", "音声→英単語", "4択", "順番通り"],
      ["全員", "単元A", "音声→英単語", "4択", "ランダム"],
      ["全員", "単元A", "音声→英単語", "タイピング", "順番通り"],
      ["全員", "単元A", "音声→英単語", "タイピング", "ランダム"],
      ["全員", "単元A", "音声→英単語", "音声", "順番通り"],
      ["全員", "単元A", "音声→英単語", "音声", "ランダム"]
    ];
